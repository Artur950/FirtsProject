...
class Ui_MainWindow(object):
    # В данном методе описаны все используемые графические элементы ( кнопка, поля ввода, выпадающие списки и т.д.)
    # Создание объектов виджета в соответствующих контейнерах и присваивание им правильных имен объектов
